<section class="banner-container">
	<div style="background-image: url('<?php echo INCLUDE_PATH; ?>images/01.png');" class="banner-single"></div><!--banner-single-->
	<div style="background-image: url('<?php echo INCLUDE_PATH; ?>images/02.png');" class="banner-single"></div><!--banner-single-->
	...
	<section id="comodidades">Comodidades
	<div class="center">
			<h2 class="title">Comodidades</h2>
	...
	<section id="localizacao"><h2>Localização</h2></section>
	<section id="contatos"><h2>Contatos</h2></section>